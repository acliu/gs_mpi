...
# aprun -n 48 python-mpi /global/homes/m/mpresley/gs_mpi/mpi_Q_matrix_grid_mult_fq_2.py {3} {4} 10
...
cd $PBS_O_WORKDIR 
# beam_sig,del_bl,num_bl (for one side of grid)
aprun -n 24 python-mpi /global/homes/m/mpresley/scripts/mpi_gsm_grid.py {3} {4} 10
""".format(kk,kk,kk,beam_sig,del_bl)
