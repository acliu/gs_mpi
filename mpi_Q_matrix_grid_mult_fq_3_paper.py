...
maxl = int(sys.argv[2])
del_bl = float(sys.argv[3])
sqGridSideLen = int(sys.argv[4])
...
#***Here's where I need to change to paper beam
...
beam = a.amp.BeamAlm(fqs, nside=32, lmax=20, mmax=20, deg=7)
amp = beam.response((tx,ty,tz))
